...
Wymagania:
- Wzorzec szachownicy o znanym rozmiarze kwadratów
- Minimum 20 różnych pozycji wzorca
- Dobra jakość obrazów (ostrosc, oswietlenie)
...
class CameraCalibrator:
    ...
    def collect_calibration_images(self, min_images: int = 20) -> bool:
        ...
        """
        print(f"\n🎯 Rozpoczynam zbieranie obrazów kalibracyjnych")
        print(f"📋 Instrukcje:")
        print(
        ...
        print(f"   • Naciśnij SPACJĘ aby wykonać zdjęcie")
        print(f"   • Potrzebuję minimum {min_images} dobrych obrazów")
        print(f"   • Naciśnij ESC aby zakończyć")
        ...
        while successful_captures < min_images:
            ...
            # Narysuj narożniki na obrazie do wyświetlenia
            ...
            if key == 27:  # ESC
                ...
                if ret:
                    ...
                    print(f"✓ Obraz {successful_captures} zapisany")
                    ...
                    print("✗ Nie znaleziono narożników - spróbuj ponownie")

        cv2.destroyAllWindows()

        print(f"\n📊 Zebrano {successful_captures} obrazów kalibracyjnych")
...
def main():
    ...
    print("🎯 KALIBRACJA KAMERY ORBEC GEMINI 335LE")
    print("=" * 50)
