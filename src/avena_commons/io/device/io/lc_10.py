...
class LC_10_Slave(EtherCatSlave):
    ...
    def _read_pdo(self):
        ...
        # print(f"Reading PDO from LC10 {input_data}")
    ...
    def _write_pdo(self):
        ...
        # print(f"Writing PDO to LC10 {output_bytes}")
    ...
    def _process(self):
        ...
        match self.fsm:
            case LC10_FSM.IDLE:
                if self.init_drive:
                    self.fsm = LC10_FSM.STARTING
                else:
                    self.init_drive_cmd()
            case LC10_FSM.STARTING:
                self.process_init()
            case LC10_FSM.OPERATIONAL:
                #pass
                # self.run_jog(speed=-1000, accel=100, decel=100)
                # self.save_position = self.actual_position
                
                pass
            case LC10_FSM.START_PROFILE_VELOCITY:
    ...
    def is_motor_running(self) -> bool:
        ...
        return self.fsm == LC10_FSM.IN_PROFILE_VELOCITY
