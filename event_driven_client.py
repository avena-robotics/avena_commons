...
from src.avena_commons.event_listener import Event, EventListener
from src.avena_commons.event_listener.types import IoAction, IoSignal, KdsAction
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default=DESTINATION_NAME, help="Name of the destination (default: io)")
    parser.add_argument("--device", type=int, default=1, help="Device ID (default: 1)")
    parser.add_argument("--rpi", type=int, default=0, help="Use RPI for destination (default: 0)")
    parser.add_argument(
        "--event",
        type=int,
        default=0,
    ...
    if args.rpi == 1:
        base_url = f"http://192.168.20.192:8010"
    ...
    # maintenance events
    event1000 = "chamber_maintenance_enable"
    event1001 = "chamber_maintenance_disable"
    event1002 = "all_chambers_maintenance_enable"  # 3x 1000
    event1003 = "all_chambers_maintenance_disable"  # 3x 1001

    event1004 = "all_wydawkas_maintenance_enable"  # 3x 1006
    event1005 = "all_wydawkas_maintenance_disable"  # 3x 1007
    event1006 = "wydawka_maintenance_enable"
    event1007 = "wydawka_maintenance_disable"

    event1008 = "oven_maintenance_enable"
    event1009 = "oven_maintenance_disable"
    ...
    if event_number > 0:
        ...
        data_origin = {"device_id": DEVICE_ID, "sauce_id": 33}  # TUTAJ ZMIENIASZ DEVICE_ID
        ...
        elif event_number == 170:
            for i in range(100):
                print("~~~~~~~~~~~~")
                print(f"Test feeder event iteration: {i + 1}/100")
                event_name = event17
                data = IoAction(device_type="feeder", device_id=data["device_id"]).to_dict()
                is_processed = True
        ...
        elif event_number == 1000:  # chamber maintenance enable
            event_name = event1000
        elif event_number == 1001:  # chamber maintenance disable
            event_name = event1001

        elif event_number == 1002:  # all chambers maintenance enable
            for i in range(3):
                event_name = event1000
                data = IoAction(device_type="chamber", device_id=i + 1).to_dict()
                is_processed = False
        ...
        elif event_number == 1003:  # all chambers maintenance disable
            for i in range(3):
                event_name = event1001
                data = IoAction(device_type="chamber", device_id=i + 1).to_dict()
                is_processed = False
        ...
        elif event_number == 1004:  # all wydawkas maintenance enable
            for i in range(3):
                event_name = event1006
                data = IoAction(device_type="wydawka", device_id=i + 1).to_dict()
                is_processed = True
        ...
        elif event_number == 1005:  # all wydawkas maintenance disable
            for i in range(3):
                event_name = event1007
                data = IoAction(device_type="wydawka", device_id=i + 1).to_dict()
                is_processed = True
        ...
        elif event_number == 1006:  # wydawka maintenance enable
            event_name = event1006
            data = IoAction(device_type="wydawka", device_id=data["device_id"]).to_dict()
            is_processed = True
        elif event_number == 1007:  # wydawka maintenance disable
            event_name = event1007
            data = IoAction(device_type="wydawka", device_id=data["device_id"]).to_dict()
            is_processed = True

        elif event_number == 1008:  # oven maintenance enable
            event_name = event1008
            data = IoAction(device_type="oven", device_id=1).to_dict()
            is_processed = True
        elif event_number == 1009:  # oven maintenance disable
            event_name = event1009
            data = IoAction(device_type="oven", device_id=1).to_dict()
            is_processed = True
        ...
        if event_name == event69 and event_number == 69:
            ...
            try:
                feeder_1_succes = 0  # Best 1099
                feeder_2_succes = 0  # Best 1040
                feeder_3_succes = 0  # Best 1094
                licznik_pentli = 0  # while True:
                for _ in range(500):  ### ILOŚĆ POWTÓRZEŃ
                    for device_id in range(1, 4):
                        # device_id = 3
                        # if device_id ==2: continue
        ...
        elif event_number == 71:
            try:
                for i in range(8):  ### ILOŚĆ POWTÓRZEŃ
                    device_id = 1
                    data = {"device_id": device_id, "sauce_id": 1}
                    event = Event(
                        source="munchies_algo",
        ...
        elif event_number == 72:
            try:
                for i in range(100):  ### ILOŚĆ POWTÓRZEŃ
                    device_id = 2
                    data = {"device_id": device_id, "sauce_id": 1}
                    event = Event(
                        source="munchies_algo",
